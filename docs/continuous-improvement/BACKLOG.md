...
| INT-20260820-002 | 내부 | readiness `*_available` 시리즈 17개 실패 원인 조사 | Reactive | NEW | P3 | env 주입에도 미해제(readiness_api·status_page·ops_runbook·게이트류 등). 판정 로직(lib/service-readiness*)이 무엇을 검사하는지 코드 확인 필요 — 다음 루프 ANALYZE |
