  ...
  return (
    <main className="policy-page">
      ...
      <section className="policy-grid">
        ...
        <article className="policy-card">
          <h2>2-1. 브라우저에만 저장되는 정보 (가격 알림·북마크·최근 검색)</h2>
          <p>
            가격 알림 목표가와 저장 시점 가격, 찜한 여정, 최근 검색 조건은 회원님의 브라우저 저장소(localStorage)에만 저장되며 서버로 전송되지 않습니다.
            이메일 주소를 입력하셔도 발송 기능이 준비되기 전까지는 서버에 전송·저장되지 않고 브라우저에만 남습니다. 브라우저 데이터 삭제 시 함께 사라집니다.
          </p>
        </article>
